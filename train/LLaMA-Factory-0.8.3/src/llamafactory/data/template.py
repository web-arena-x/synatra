    ...
    def _encode(
        ...
        for i, message in enumerate(messages):
            ...
            if i == 0:
                ...
                if system or tools:
                    tool_text = (
                        self.format_tools.apply(content=tools)[0]
                        if tools
                        else ""
                    )
        ...
        for elem in elements:
            if isinstance(elem, str):
                ...
                if "bos_token" in elem and tokenizer.bos_token_id is not None:
                    ...
                    "eos_token" in elem and tokenizer.eos_token_id is not None
                ):
...
def _register_template(
    ...
    default_function_formatter = FunctionFormatter(
        slots=eos_slots, tool_format="default"
    )
...
def _get_jinja_template(
    template: "Template", tokenizer: "PreTrainedTokenizer"
) -> str:
    jinja_template = ""
...
def get_template_and_fix_tokenizer(
    ...
    if tool_format is not None:
        ...
        template.format_function = FunctionFormatter(
            slots=eos_slots, tool_format=tool_format
        )
